...
class Medicos extends CI_Controller{
    ...
    public function index(){
        ...
        $opciones['base_url'] = base_url().'index.php/medicos/index';
        $opciones['total_rows'] = $this->Medicos_model->numeroMedicos();
        ...
        $data['lista'] = $this->Medicos_model->mostrarResultados($opciones['per_page'],$desde);
        $data['paginacion'] = $this->pagination->create_links();
        $this->load->view('folder_medicos/cabecera_medicos_view');
        $this->load->view('menu_administradores_view');
        $this->load->view('folder_medicos/medicos_view',$data);
        $this->load->view('footer_view');
    }
    
    public function insertar_medico_view(){
        $this->load->helper('form');
        $this->load->view('folder_medicos/cabecera_medicos_view');
        $this->load->view('menu_administradores_view');
        $this->load->view('folder_medicos/medicos_insertar');
        $this->load->view('footer_view');
    }

    public function insertar_medico(){
        $this->load->model('Medicos_model');
        $this->reglas_validacion();
        if($this->form_validation->run()==FALSE){
            $this->insertar_medico_view();
        }
        else{
            $data = array(
            ...
            $this->Medicos_model->insertarMedico($data);
            redirect('index.php/medicos/paginar');
        }
    }
    
    public function buscar_medico_view(){
        $this->load->model('Medicos_model');
        $this->load->library('pagination');
        ...
        $opciones['num_links'] = 5;
        $opciones['base_url'] = base_url().'index.php/medicos/index';
        $opciones['total_rows'] = $this->Medicos_model->numeroMedicosBusqueda($busqueda,$parametro);
        $opciones['uri_segment'] = 3;
        $opciones['first_link'] = 'Primero';
        $opciones['last_link'] = 'Ultimo';
        $opciones['next_link'] = 'Siguiente';
        $opciones['prev_link'] = 'Anterior';
        $this->pagination->initialize($opciones);
        $data['lista'] = $this->Medicos_model->mostrarResultadosBusqueda($opciones['per_page'],$desde,$busqueda,$parametro);
        $data['paginacion'] = $this->pagination->create_links();
        $this->load->view('folder_medicos/cabecera_medicos_view');
        $this->load->view('menu_administradores_view');
        $this->load->view('folder_medicos/medicos_view',$data);
    ...
    public function editar_medico_view(){
        $this->load->helper('form');
        ...
        $this->load->view('folder_medicos/cabecera_medicos_view');
        $this->load->view('menu_administradores_view');
        $this->load->view('folder_medicos/medicos_editar',$data);
        $this->load->view('footer_view');
    }
    
    public function editar_medico(){
        $this->load->model('Medicos_model');
        $data = array( 
            'nombres' => $this->input->post('nombres'),
            'apellidos' => $this->input->post('apellidos'),
            ...
            $this->Medicos_model->editarMedico($data,$old_id);
            redirect('index.php/medicos/paginar');
    }
    
    public function editar_medico_permisos_view(){
        $this->load->helper('form');
        $id = $this->uri->segment('3');
        $this->load->model('Medicos_model');
        $query = $this->db->get_where("usuarios",array("id_usuarios"=>$id));
        ...
        $this->load->view('folder_medicos/cabecera_medicos_view');
        $this->load->view('menu_administradores_view');
        $this->load->view('folder_medicos/medicos_editar_permisos',$data);
        $this->load->view('footer_view');
    }
    
    public function editar_medico_permisos(){
        $this->load->model('Medicos_model');
        $data_per = array( 
        ...
        $old_id = $this->input->post('old_id'); 
        $this->Medicos_model->editarMedicoPermisos($data_per,$old_id);
        redirect('index.php/medicos/paginar');
    }
    ...
    public function eliminar_medico(){
        $this->load->model('Medicos_model'); 
        $id = $this->uri->segment('3'); 
        $this->Medicos_model->eliminarMedico($id);
        redirect('index.php/medicos/paginar');
    }
    ...
    public function validar_username($username){
        $this->load->model('Medicos_model');
        if($this->Medicos_model->existeUsername($username)){
    ...
    public function validar_celular($celular){
        $this->load->model('Medicos_model');
        if($this->Medicos_model->existeCelular($celular)){
    ...
    public function validar_correo($correo){
        $this->load->model('Medicos_model');
        if($this->Medicos_model->existeCorreo($correo)){
...
//        $section->addText(' ');
        ...
        $section->addText('Lista de medicos', $estiloFuenteLista, $estiloParrafoLista);
        //Lista de administradores
        ...
        $contenido = $this->Medicos_model->obtenerResultadosExportarWord();
        //Obtenemos el numero de filas de la tabla seleccionada
        
        
        //Recorremos la tabla
        for ($row = 0; $row < count($this->Medicos_model->numeroMedicos()); $row++){
        ...
        $filename='Lista_Medicos.docx'; //save our document as this file name
...
//        $section->addText(' ');
        ...
        $section->addText('Perfil del medico', $estiloFuentePerfil, $estiloParrafoPerfil);
        //Perfil de administrador

        //Obtenemos el numero de filas de la tabla seleccionada
        $contenido = $this->Medicos_model->obtenerResultadosExportarWord_ID($id);
        //Obtenemos el numero de filas de la tabla seleccionada
        ...
        //Creamos y guardamos el documento
        $filename="Medico_".$nomAdmin.".docx";
//        $filename='Perfil_de_administrador.docx'; //save our document as this file name
    ...
    public function exportar_excel(){
        ...
        $this->excel->setActiveSheetIndex(0)->setCellValue('A6','Lista de medicos');
        ...
        $this->excel->getActiveSheet()->setTitle('Lista de medicos')
        ...
        $this->load->database();
        $this->load->model('Medicos_model');
        $medicos = $this->Medicos_model->obtenerResultadosExportarExcel();
        $this->excel->getActiveSheet()->fromArray($medicos, null, 'A9');
        
        //Datos array
        
        //Archivo descargado
        $filename='Lista_de_medicos.xls';
    ...
    public function exportar_excel_id(){
        ...
        //Titulo Lista de medicos
        $this->excel->setActiveSheetIndex(0)->setCellValue('B6','Perfil del medico');
        ...
        $this->excel->getActiveSheet()->setTitle('Perfil del medico')
            ->getColumnDimension('B')
                ->setAutoSize(TRUE);
        $this->load->database();
        $this->load->model('Medicos_model');
        $medicos = $this->Medicos_model->obtenerResultadosExportarExcel_ID($id);
        foreach ($medicos as $result){
            $this->excel->setActiveSheetIndex(0)
            ...
            $nomMedi = "".$result['nombres']." ".$result['apellidos']."";
        }
    ...
    public function exportar_pdf(){
        $this->load->model('Medicos_model');
        $data['title']='Lista de medicos'; 
        $data['author']='Administrador';
	$data['subject']='Lista de medicos'; 	 
	$data['content']= $this->Medicos_model->obtenerResultadosExportarPDF();
	$this->load->view('folder_medicos/medicos_exportar_pdf',$data);
    }
    
    public function exportar_pdf_id(){
        $this->load->model('Medicos_model');
        $id = $this->uri->segment('3');
        $data['title']='Perfil de medico'; 
        $data['author']='Administrador';
	$data['subject']='Perfil de medico';	 
	$data['content']= $this->Medicos_model->obtenerResultadosExportarPDF_ID($id);
	$this->load->view('folder_medicos/medicos_exportar_pdf_id',$data);
    }
