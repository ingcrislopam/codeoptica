        ...
        <?php
            if($word=="Si"){
                echo "<p align='center'><a href = '".base_url()."index.php/recepcionistas/exportar_word/'><img src='".base_url()."imagenes/word.png' title='WORD'></a>";
            }
            else{
            ...
            echo " ";
            if($excel=="Si"){
                echo "<a href = '".base_url()."index.php/recepcionistas/exportar_excel/'><img src='".base_url()."imagenes/excel.png' title='EXCEL'></a>";
            }
            else{
            ...
            echo " ";
            if($pdf=="Si"){
                echo "<a href = '".base_url()."index.php/recepcionistas/exportar_pdf/'><img src='".base_url()."imagenes/pdf.png' title='PDF'></a></p>";
            }
            else{
        ...
        <div id="contenedor">
        <?php
                echo form_open('index.php/recepcionistas/buscar_recepcionista_view');
                echo "<h3>BUSQUEDA DE RECEPCIONISTA POR</h3>";
...
//                            '' => 'Seleccione',
                    ...
                    if($buscar=="Si"){
                        ...
                        echo "</td>";
                        echo "<td nowrap>";
                            echo form_input(array('type'=>'image', 'src'=>'http://localhost/codeoptica/imagenes/buscar.png', 'title'=>'BUSCAR RECEPCIONISTA'));
                        echo "</td>";
                    }
                    else{
                        echo "<td nowrap>";
                        ...
                        echo "</td>";
                        echo "<td nowrap>";
                            echo "<a><img src='".base_url()."imagenes/buscarbn.png' title='BUSCAR RECEPCIONISTA'></a>";
                        echo "</td>";
                    }
                echo "</table>";
                echo form_close(); 
...
<!--        <br>-->
        ...
        echo "<td>";
        if($agregar=="Si"){
            echo "<a href = '".base_url()."index.php/recepcionistas/insertar_recepcionista_view/'><img src='".base_url()."imagenes/agregar.png'> Nuevo recepcionista</a>";
        }
        else{
            echo "<a><img src='".base_url()."imagenes/agregarbn.png'> Nuevo recepcionista</a>";
        }
            echo "<div id='datos'>";
...
//                echo "<td nowrap><a href = '".base_url()."index.php/recepcionistas/editar_recepcionista_permisos_view/"
//                    .$d->id_usua."'><img src='".base_url()."imagenes/permisos.png' title='PERMISOS'></a>";
//                echo " ";
                if($editar=="Si"){
                    echo "<td nowrap><a href = '".base_url()."index.php/recepcionistas/editar_recepcionista_view/"
                ...
                echo "  ";
                if($eliminar=="Si"){
                    echo "<a href = '".base_url()."index.php/recepcionistas/eliminar_recepcionista/"
                ...
                if($word=="Si"){
                    echo "<td nowrap><a href = '".base_url()."index.php/recepcionistas/exportar_word_id/"
                ...
                echo " ";
                if($excel=="Si"){
                    echo "<a href = '".base_url()."index.php/recepcionistas/exportar_excel_id/"
                ...
                echo " ";
                if($pdf=="Si"){
                    echo "<a href = '".base_url()."index.php/recepcionistas/exportar_pdf_id/"
