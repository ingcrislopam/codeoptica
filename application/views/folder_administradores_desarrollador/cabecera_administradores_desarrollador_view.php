...
<html>
    ...
    <head> 
        ...
        <link rel="stylesheet" type="text/css" href="<?= base_url() ?>estilos/css/administradores_desarrollador.css">
    </head>
    ...
    <body background="<?= base_url() ?>imagenes/fondo.jpg" >
        ...
        <div>
            <h2>Bienvenido(a) al sistema: <?php echo "" .$nombresUsu ?> | Tipo de usuario: Administrador</h2>
        </div>
