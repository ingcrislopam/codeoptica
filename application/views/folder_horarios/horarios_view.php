        ...
        <?php
            if($word=="Si"){
                echo "<p align='center'><a href = '".base_url()."index.php/horarios/exportar_word/'><img src='".base_url()."imagenes/word.png' title='WORD'></a>";
            }
            else{
            ...
            echo " ";
            if($excel=="Si"){
                echo "<a href = '".base_url()."index.php/horarios/exportar_excel/'><img src='".base_url()."imagenes/excel.png' title='EXCEL'></a>";
            }
            else{
            ...
            echo " ";
            if($pdf=="Si"){
                echo "<a href = '".base_url()."index.php/horarios/exportar_pdf/'><img src='".base_url()."imagenes/pdf.png' title='PDF'></a></p>";
            }
            else{
        ...
        <div id="contenedor">
        <?php
                echo form_open('index.php/horarios/buscar_horarios_view');
...
//                            '' => 'Seleccione',
        ...
        echo "<td>";
        if($agregar=="Si"){
            echo "<a href = '".base_url()."index.php/horarios/insertar_horarios_view/'><img src='".base_url()."imagenes/agregar.png'> Nuevo horario con turnos</a>";
        }
        else{
...
//                echo "<td nowrap></td>";
                ...
                if($editar=="Si"){
                    echo "<td nowrap><a href = '".base_url()."index.php/horarios/editar_horarios_view/"
                ...
                echo "  ";
                if($eliminar=="Si"){
                    echo "<a href = '".base_url()."index.php/horarios/eliminar_horarios/"
                ...
                if($word=="Si"){
                    echo "<td nowrap><a href = '".base_url()."index.php/horarios/exportar_word_id/"
                ...
                echo " ";
                if($excel=="Si"){
                    echo "<a href = '".base_url()."index.php/horarios/exportar_excel_id/"
                ...
                echo " ";
                if($pdf=="Si"){
                    echo "<a href = '".base_url()."index.php/horarios/exportar_pdf_id/"
