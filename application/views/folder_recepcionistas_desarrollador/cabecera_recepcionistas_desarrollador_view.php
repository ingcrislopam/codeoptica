...
<html>
    ...
    <head> 
        ...
        <link rel="stylesheet" type="text/css" href="<?= base_url() ?>estilos/css/recepcionistas_desarrollador.css">
    </head>
    ...
    <body background="<?= base_url() ?>imagenes/fondo.jpg" >
        ...
        <div>
            <h2>Bienvenido(a) al sistema: <?php echo "" .$nombresUsu ?> | Tipo de usuario: Recepcionista</h2>
        </div>
