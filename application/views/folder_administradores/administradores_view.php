        ...
        <?php
            if($word=="Si"){
                echo "<p align='center'><a href = '".base_url()."index.php/administradores/exportar_word/'><img src='".base_url()."imagenes/word.png' title='WORD'></a>";
            }
            else{
            ...
            echo " ";
            if($excel=="Si"){
                echo "<a href = '".base_url()."index.php/administradores/exportar_excel/'><img src='".base_url()."imagenes/excel.png' title='EXCEL'></a>";
            }
            else{
            ...
            echo " ";
            if($pdf=="Si"){
                echo "<a href = '".base_url()."index.php/administradores/exportar_pdf/'><img src='".base_url()."imagenes/pdf.png' title='PDF'></a></p>";
            }
            else{
        ...
        <div id="contenedor">
        <?php
                echo form_open('index.php/administradores/buscar_administrador_view');
                echo "<h3>BUSQUEDA DE ADMINISTRADOR POR</h3>";
...
//                            '' => 'Seleccione',
                    ...
                    if($buscar=="Si"){
                        ...
                        echo "</td>";
                        echo "<td nowrap>";
                            echo form_input(array('type'=>'image', 'src'=>'http://localhost/codeoptica/imagenes/buscar.png', 'title'=>'BUSCAR ADMINISTRADOR'));
                        echo "</td>";
                    }
                    else{
                        echo "<td nowrap>";
                        ...
                        echo "</td>";
                        echo "<td nowrap>";
                            echo "<a><img src='".base_url()."imagenes/buscarbn.png' title='BUSCAR ADMINISTRADOR'></a>";
                        echo "</td>";
                    }
                echo "</table>";
                echo form_close(); 
...
<!--        <br>-->
        ...
        echo "<td>";
        if($agregar=="Si"){
            echo "<a href = '".base_url()."index.php/administradores/insertar_administrador_view/'><img src='".base_url()."imagenes/agregar.png'> Nuevo administrador</a>";
        }
        else{
            echo "<a><img src='".base_url()."imagenes/agregarbn.png'> Nuevo administrador</a>";
        }
            echo "<div id='datos'>";
...
//                echo "<td nowrap><a a href = '".base_url()."index.php/administradores/editar_administrador_permisos_view/"
//                    .$d->id_usua."'><img src='".base_url()."imagenes/permisos.png' title='PERMISOS'></a>";
//                echo " ";
                if($editar=="Si"){
                    echo "<td nowrap><a href = '".base_url()."index.php/administradores/editar_administrador_view/"
                ...
                echo "  ";
                if($eliminar=="Si" && $d->id_usua!=$idUsuario){
                    echo "<a href = '".base_url()."index.php/administradores/eliminar_administrador/"
                ...
                if($word=="Si"){
                    echo "<td nowrap><a href = '".base_url()."index.php/administradores/exportar_word_id/"
                ...
                echo " ";
                if($excel=="Si"){
                    echo "<a href = '".base_url()."index.php/administradores/exportar_excel_id/"
                ...
                echo " ";
                if($pdf=="Si"){
                    echo "<a href = '".base_url()."index.php/administradores/exportar_pdf_id/"
