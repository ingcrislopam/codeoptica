...
class Administradores_model extends CI_Model{
    ...
    public function insertarAdministrador($data){
        ...
        $this->db->insert("administrador", $data_administrador);
        $this->db->insert("permisos", $data_permisos);
    }
    
    public function existeAdministrador($nombres, $apellidos, $username){
    ...
    public function editarAdministrador($data, $old_id){
        $this->db->set($data);
    ...
    public function editarAdministradorPermisos($data_per, $old_id){
        $this->db->set($data_per);
        $this->db->where("id_usuarios", $old_id);
        $this->db->update("permisos", $data_per);
    }
    ...
    public function eliminarAdministrador($id){
        $this->db->delete("administrador", "id_usuarios = ".$id);
        $this->db->delete("permisos", "id_usuarios = ".$id);
        $this->db->delete("usuarios", "id_usuarios = ".$id);
    }
    
    public function numeroAdministradores()
    {
        $estado = 1;
    ...
    public function numeroAdministradoresBusqueda($busqueda,$parametro)
    {
        $estado = 1;
        $this->db->select("*");
        $this->db->from('usuarios');
